...
A beautiful, interactive mini website I built to celebrate my pandhi 🐽 fellow special day ❤️.  
...
## 🚀 Live Demo  
👉 [Click here to view the site](https://happybirthdaypriyamma.vercel.app/)  
...
1. Clone the repo:  
   ```bash
   git clone https://github.com/giridharkalapala/Priyamma.git
